...
class MicropostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create micropost" do
    assert_difference('Micropost.count') do
      post microposts_url, params: { micropost: { contant: @micropost.contant, user_id: @micropost.user_id } }
    end
  ...
  test "should update micropost" do
    patch micropost_url(@micropost), params: { micropost: { contant: @micropost.contant, user_id: @micropost.user_id } }
